...
void DrawPlayerScore( SDL_Renderer* renderer, TTF_Font* Font, const int& score){
...
void DrawPlayerHighScore(SDL_Renderer* Renderer, TTF_Font* Font, const string& HighScore){
